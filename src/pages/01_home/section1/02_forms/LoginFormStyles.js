...
const LoginFormWrapper = styled.form`
    ...
    display: ${({loginVisible}) => loginVisible ? "flex" : "none"};
    z-index: 100;
`
...
const SendResetLink = styled(LogIn)`
    height: 20px;
    font-size: 0.6rem;
`
...
export { LoginFormWrapper, InputWrapper, Username, Password, Caption, LostPassword, ButtonsWrapper, LogIn, Cancel,  ResetLinkWrapper, SendResetLink, EmailResetLink, Register  }