...
const sentences = [
  ...
  { beginning: "By next month, Sarah", bold: "read (future)", correct: "will have been reading", ending: "this book for a year." },
  { beginning: "Before the bell rang, the students", bold: "study (past)", correct: "had been studying", ending: "for two hours." },
  { beginning: "By this time next week, Tom", bold: "work (future)", correct: "will have been working", ending: "at the company for five years." },
  { beginning: "When he arrived, I", bold: "cook (past)", correct: "had been cooking", ending: "dinner for half an hour." },
  { beginning: "By 2026, we", bold: "live (future)", correct: "will have been living", ending: "in this city for a decade." },
  { beginning: "Before 2010, they", bold: "live (past)", correct: "had been living", ending: "in London for several years." },
  { beginning: "By the end of the day, they", bold: "travel (future)", correct: "will have been traveling", ending: "for twelve hours." },
  { beginning: "When we met, she", bold: "work (past)", correct: "had been working", ending: "on that project for months." },
  //lesson 29 8 rules
  { beginning: "", bold: "Playing tennis (Lilly)", correct: "Lilly is playing tennis", ending: "" },
  { beginning: "", bold: "Watching TV (Tom)", correct: "Tom is watching TV", ending: "" },
  { beginning: "", bold: "Cooking dinner (Rachel)", correct: "Rachel is cooking dinner", ending: "" },
  { beginning: "", bold: "Reading a book (Ben)", correct: "Ben is reading a book", ending: "" },
  { beginning: "", bold: "Writing a letter (Sophie)", correct: "Sophie is writing a letter", ending: "" },
  { beginning: "", bold: "Listening to music (Emma)", correct: "Emma is listening to music", ending: "" },
  { beginning: "", bold: "Running in the park (Jack)", correct: "Jack is running in the park", ending: "" },
  { beginning: "", bold: "Drinking coffee (Olivia)", correct: "Olivia is drinking coffee", ending: "" },

  //lesson 30 8 rules
  { beginning: "", bold: "Kyle a student", correct: "Kyle is a student", ending: "" },
  { beginning: "", bold: "Marry sad", correct: "Marry is sad", ending: "" },
  { beginning: "", bold: "Tom hungry", correct: "Tom is hungry", ending: "" },
  { beginning: "", bold: "The cat on the sofa", correct: "The cat is on the sofa", ending: "" },
  { beginning: "", bold: "My father a doctor", correct: "My father is a doctor", ending: "" },
  { beginning: "", bold: "The weather nice", correct: "The weather is nice", ending: "" },
  { beginning: "", bold: "Your keys on the table", correct: "Your keys are on the table", ending: "" },
  { beginning: "", bold: "They ready", correct: "They are ready", ending: "" }
]
...
const instructions = [
  ...
  "Змініть дієслово на форму теперішнього доконаного тривалого часу",
  "Перекладіть у правильномк тривалому часі",
  ...
  "Замініть на правильне слово - дія відбувалася перед розмовою",
  "Вставте слово в часі, вказаному в дужках",
  "Вставте констукцію в часі, вказаному в дужках",
  "Вставте конструкцію в теперішньому доконаному тривалому часі",
  "Вставте конструкцію в одному з теперішніх часів",
  "Вставте конструкцію в минулому або майбутньому доконаному тривалому часі",
  "Побудуйте повні речення в теперішньому тривалому часі",
