const sentences = [
    ...
    //lesson 29 8 rules
    { sentence: "Люблю я яблука", translat: "I like apples" },
    { sentence: "Книжку вона читає", translat: "She is reading a book" },
    { sentence: "У банку він працює", translat: "He works in a bank" },
    { sentence: "Пішли ми до школи", translat: "We went to school" },
    { sentence: "Бачив я цей фільм", translat: "I have seen this movie" },
    { sentence: "Музику вони слухають", translat: "They are listening to music" },
    { sentence: "Готує мама вечерю", translat: "Mom is cooking dinner" },
    { sentence: "Зустрілися ми в парку", translat: "We met in the park" },

    //lesson 30 8 rules
  { sentence: "Do you a teacher?", translat: "Are you a teacher?" },
  { sentence: "Are you like shopping?", translat: "Do you like shopping?" },
  { sentence: "Do he your brother?", translat: "Is he your brother?" },
  { sentence: "Is she play tennis?", translat: "Does she play tennis?" },
  { sentence: "Does it raining?", translat: "Is it raining?" },
  { sentence: "Do they students?", translat: "Are they students?" },
  { sentence: "Is he live here?", translat: "Does he live here?" },
  { sentence: "Is you hungry?", translat: "Are you hungry?" }
]
...
const instructions = [
  ...
  "Перекладіть речення в теперішньому доконаному тривалому часі",
  "Перекладіть речення в минулому або майбутньому доконаному часі",
  "Побюдуйте речення, використовуючи правильний порядок слів",
